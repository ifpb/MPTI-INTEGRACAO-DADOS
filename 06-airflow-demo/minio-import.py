...
with DAG(
    ...
    file_download_step = BashOperator(
        ...
        bash_command='wget https://s3.sa-east-1.amazonaws.com/ckan.saude.gov.br/SGL/2021/uf=PB/lote=1/part-00000-f1f02999-8ba2-40f4-8598-df433a6f0190.c000.csv -P /Users/diegopessoa/airflow/downloads/',
    )
